...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://database_tc3s_user:FJlu8o0XdPhHnNF9P9jVn1yMWcIm6Hl8@dpg-ccs4njkgqg48cgsuf4vg-a.oregon-postgres.render.com/database_tc3s'
db = SQLAlchemy(app)
